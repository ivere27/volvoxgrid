...
make android-run VOLVOXGRID_SOURCE=maven VOLVOXGRID_VERSION=0.5.0
```
...
make docker_android_aar docker_desktop VOLVOXGRID_VERSION=0.5.0-SNAPSHOT
```
...
|---|---|---|
| **Line 1** | `Engine v0.5.0-SNAPSHOT · 59ccdeb · 2026-03-02 14:46 UTC` | Engine version, short git commit, and UTC build date. |
