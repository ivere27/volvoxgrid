...
```kotlin
dependencies {
    implementation("io.github.ivere27:volvoxgrid-desktop:0.8.1")
}
```
...
Examples below use `0.8.1`. Replace it with the release you want to consume.
...
dependencies {
    ...
    // or: implementation("io.github.ivere27:volvoxgrid-android-lite:0.8.1")
}
```
