...
static RUNTIME_VOLVOX_GRID_SERVICE: std::sync::OnceLock<Box<dyn VolvoxGridServiceRuntime>> =
    std::sync::OnceLock::new();

pub fn register_volvox_grid_service_runtime(runtime: impl VolvoxGridServiceRuntime) {
    let _ = RUNTIME_VOLVOX_GRID_SERVICE.set(Box::new(runtime));
}

fn get_volvox_grid_service_runtime() -> Option<&'static dyn VolvoxGridServiceRuntime> {
    Some(
        RUNTIME_VOLVOX_GRID_SERVICE
            .get_or_init(super::create_runtime)
            .as_ref(),
    )
}
    ...
    match method_str {
        "/volvoxgrid.v1.VolvoxGridService/Create" => {
            match CreateRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.create(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
        ...
        "/volvoxgrid.v1.VolvoxGridService/Destroy" => {
            match DestroyRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.destroy(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/Configure" => {
            match ConfigureRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.configure(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/GetConfig" => {
            match GetConfigRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.get_config(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/LoadFontData" => {
            match LoadFontDataRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.load_font_data(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/DefineColumns" => {
            match DefineColumnsRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.define_columns(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/GetSchema" => {
            match GetSchemaRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.get_schema(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/DefineRows" => {
            match DefineRowsRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.define_rows(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/InsertRows" => {
            match InsertRowsRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.insert_rows(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/RemoveRows" => {
            match RemoveRowsRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.remove_rows(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/MoveColumn" => {
            match MoveColumnRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.move_column(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/MoveRow" => {
            match MoveRowRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.move_row(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/UpdateCells" => {
            match UpdateCellsRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.update_cells(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/GetCells" => {
            match GetCellsRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.get_cells(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/LoadTable" => {
            match LoadTableRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.load_table(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/LoadData" => {
            match LoadDataRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.load_data(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/AppendData" => {
            match AppendDataRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.append_data(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/Clear" => match ClearRequest::decode(input.as_slice()) {
            Ok(req) => match runtime.clear(req) {
                Ok(resp) => {
                    let mut buf = Vec::new();
                    if resp.encode(&mut buf).is_ok() {
                        success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/Select" => {
            match SelectRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.select(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/GetSelection" => {
            match GetSelectionRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.get_selection(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/ShowCell" => {
            match ShowCellRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.show_cell(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/SetTopRow" => {
            match SetRowRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.set_top_row(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/SetLeftCol" => {
            match SetColRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.set_left_col(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/Subtotal" => {
            match SubtotalRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.subtotal(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/AutoSize" => {
            match AutoSizeRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.auto_size(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/Outline" => {
            match OutlineRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.outline(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/GetNode" => {
            match GetNodeRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.get_node(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/Aggregate" => {
            match AggregateRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.aggregate(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/GetMergedRange" => {
            match GetMergedRangeRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.get_merged_range(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/MergeCells" => {
            match MergeCellsRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.merge_cells(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/UnmergeCells" => {
            match UnmergeCellsRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.unmerge_cells(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/GetMergedRegions" => {
            match GetMergedRegionsRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.get_merged_regions(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/GetMemoryUsage" => {
            match GetMemoryUsageRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.get_memory_usage(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/Clipboard" => {
            match ClipboardCommand::decode(input.as_slice()) {
                Ok(req) => match runtime.clipboard(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/Export" => {
            match ExportRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.export(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/Print" => match PrintRequest::decode(input.as_slice()) {
            Ok(req) => match runtime.print(req) {
                Ok(resp) => {
                    let mut buf = Vec::new();
                    if resp.encode(&mut buf).is_ok() {
                        success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/Archive" => {
            match ArchiveRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.archive(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/ResizeViewport" => {
            match ResizeViewportRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.resize_viewport(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/SetRedraw" => {
            match SetRedrawRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.set_redraw(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/Refresh" => {
            match RefreshRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.refresh(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/LoadDemo" => {
            match LoadDemoRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.load_demo(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
        ...
        "/volvoxgrid.v1.VolvoxGridService/GetDemoData" => {
            match GetDemoDataRequest::decode(input.as_slice()) {
                Ok(req) => match runtime.get_demo_data(req) {
                    Ok(resp) => {
                        let mut buf = Vec::new();
                        if resp.encode(&mut buf).is_ok() {
                            success_response(resp_len, &buf)
    ...
    let worker = std::thread::spawn(move || {
        match method_str.as_str() {
            "/volvoxgrid.v1.VolvoxGridService/RenderSession" => {
                ...
                if let Err(e) = runtime.render_session(&bidi) {
            ...
            "/volvoxgrid.v1.VolvoxGridService/EventStream" => {
                ...
                if let Ok(req) = EventStreamRequest::decode(data.as_slice()) {
                    ...
                    if let Err(e) = runtime.event_stream(req, &sender) {
                        push_stream_error(&ctx_clone, &e);
                    }
                } else {
