...
dependencies {
    ...
    // or lite variant:
    // implementation("io.github.ivere27:volvoxgrid-android-lite:0.7.0")
}
```
...
- Lite (Maven): `make android-run VOLVOXGRID_SOURCE=maven VOLVOXGRID_VARIANT=lite VOLVOXGRID_VERSION=0.7.0`
