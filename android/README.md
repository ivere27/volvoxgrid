...
```kotlin
dependencies {
    implementation("io.github.ivere27:volvoxgrid-android:0.5.0")
    // or lite variant:
    // implementation("io.github.ivere27:volvoxgrid-android-lite:0.5.0")
}
```
...
- Lite (Maven): `make android-run VOLVOXGRID_SOURCE=maven VOLVOXGRID_VARIANT=lite VOLVOXGRID_VERSION=0.5.0`
