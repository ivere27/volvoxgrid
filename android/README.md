...
dependencies {
    ...
    // or lite variant:
    // implementation("io.github.ivere27:volvoxgrid-android-lite:0.8.4")
}
```
...
- Lite (Maven): `make android-run VOLVOXGRID_SOURCE=maven VOLVOXGRID_VARIANT=lite VOLVOXGRID_VERSION=0.8.4`
