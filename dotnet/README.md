...
dotnet add package VolvoxGrid.DotNet.Lite --version 0.8.9
```
...
```xml
<ItemGroup>
  <PackageReference Include="VolvoxGrid.DotNet" Version="0.8.9" />
  <!-- or: <PackageReference Include="VolvoxGrid.DotNet.Lite" Version="0.8.9" /> -->
</ItemGroup>
```
