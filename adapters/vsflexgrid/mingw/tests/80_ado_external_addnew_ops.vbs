' Test 80: Observe grid state after external Recordset.AddNew/Update.
...
If Err.Number = 0 Then
    ...
    rs.AddNew: rs("ITEM_CODE") = "A-01": rs("ITEM_NAME") = "Rotor": rs.Update
    rs.AddNew: rs("ITEM_CODE") = "A-02": rs("ITEM_NAME") = "Seal": rs.Update
