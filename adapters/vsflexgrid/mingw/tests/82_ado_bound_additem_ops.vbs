' Test 82: Observe recordset and grid state after AddItem on a bound grid.
...
If Err.Number = 0 Then
    ...
    rs.AddNew: rs("ITEM_CODE") = "G-01": rs("ITEM_NAME") = "Rotor": rs.Update
