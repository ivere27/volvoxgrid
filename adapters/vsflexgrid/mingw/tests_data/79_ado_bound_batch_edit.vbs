' Test 79: Observe grid and recordset state after DataMode=flexDMBoundBatch cell edits.
...
If Err.Number = 0 Then
    ...
    rs.AddNew: rs("ITEM_CODE") = "T-01": rs("ITEM_NAME") = "Rotor": rs.Update
    rs.AddNew: rs("ITEM_CODE") = "T-02": rs("ITEM_NAME") = "Seal": rs.Update
