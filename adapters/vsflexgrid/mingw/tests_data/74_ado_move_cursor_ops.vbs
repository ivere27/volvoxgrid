' Test 74: Observe grid state after Recordset.MoveLast.
...
If Err.Number = 0 Then
    ...
    rs.AddNew: rs("ITEM_CODE") = "M-01": rs("ITEM_NAME") = "Rotor": rs.Update
    rs.AddNew: rs("ITEM_CODE") = "M-02": rs("ITEM_NAME") = "Seal": rs.Update
    rs.AddNew: rs("ITEM_CODE") = "M-03": rs("ITEM_NAME") = "Bracket": rs.Update
