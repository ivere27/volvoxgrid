' Test 75: Observe grid state after Recordset.AbsolutePosition changes.
...
If Err.Number = 0 Then
    ...
    rs.AddNew: rs("ITEM_CODE") = "P-01": rs("ITEM_NAME") = "Rotor": rs.Update
    rs.AddNew: rs("ITEM_CODE") = "P-02": rs("ITEM_NAME") = "Seal": rs.Update
    rs.AddNew: rs("ITEM_CODE") = "P-03": rs("ITEM_NAME") = "Bracket": rs.Update
    ...
    posVal = CStr(rs.AbsolutePosition)
    If Err.Number <> 0 Then
        Err.Clear
        posVal = "ERR"
    End If
    ...
    fg.TextMatrix(0, 1) = "POS=" & posVal & ":" & SafeField(rs, "ITEM_CODE")
Else
    Call SetupFallback("AbsPos")
End If
