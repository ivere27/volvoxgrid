' Test 77: Observe grid state after Recordset.Bookmark repositioning.
...
If Err.Number = 0 Then
    ...
    rs.AddNew: rs("ITEM_CODE") = "B-01": rs("ITEM_NAME") = "Rotor": rs.Update
    rs.AddNew: rs("ITEM_CODE") = "B-02": rs("ITEM_NAME") = "Seal": rs.Update
    rs.AddNew: rs("ITEM_CODE") = "B-03": rs("ITEM_NAME") = "Bracket": rs.Update
